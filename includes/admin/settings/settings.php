			...
			<div id="tab_container">
				...
				<div class="tab_content" id="payments">
					<table class="form-table">
						...
						<tr>
							...
							<td>
								<p><?php _e( 'The PayPal API credentials are required in order to use PayPal Express, PayPal Pro, and to support advanced subscription cancellation options in PayPal Standard.', 'rcp' ); ?></p>
							</td>
						</tr>
				...
				<div class="tab_content" id="emails">
					<div id="rcp_email_options">
						...
						<tr valign="top">
							<th>
								<label for="rcp_settings[email_logo]"><?php _e( 'Email Logo', 'rcp' ); ?></label>
							</th>
							<td>
								<input class="regular-text rcp-upload-field" id="rcp_settings[email_logo]" style="width: 300px;" name="rcp_settings[email_logo]" value="<?php if( isset( $rcp_options['email_logo'] ) ) { echo $rcp_options['email_logo']; } ?>"/>
								<button class="button-secondary rcp-upload"><?php _e( 'Choose Logo', 'rcp' ); ?></button>
								<p class="description"><?php _e( 'Upload a logo to use as the header for emails.', 'rcp' ); ?></p>
							</td>
						</tr>
							<tr>
